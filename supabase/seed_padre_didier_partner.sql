...
cross join (
  values
    (
      'Lauds',
      array['Laudes', 'Lauds', 'Morning', 'Oración de la Mañana', 'Oracion de la Manana']::text[],
      array[]::text[],
      'lauds',
      220,
      'approved'
    ...
    (
      'Vespers',
      array['Vísperas', 'Visperas', 'Vespers', 'Evening', 'Oración de la Tarde', 'Oracion de la Tarde']::text[],
      array[]::text[],
      'vespers',
      210,
      'approved'
